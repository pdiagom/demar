...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const userExistsResponse = await checkUserExists(formData.username, formData.email);
            ...
            newErrors.general = "Ocurrió un error al verificar el usuario. Por favor, inténtelo de nuevo.";
        }
        ...
        if (Object.keys(newErrors).length === 0) {
            try {
                ...
                setErrors({ general: "Ocurrió un error durante el registro. Por favor, inténtelo de nuevo." });
            }
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="postalCode" placeholder="Postal Code" onChange={handleChange} value={formData.postalCode} />
