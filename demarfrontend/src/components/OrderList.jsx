                ...
                <tbody>
                    {orders.map(order => (
                        <tr key={order.idOrder}>
                            ...
                            <td>
                                 {editingOrder === order.idOrder ? (
                                    <button className="btn-primary" onClick={() => setEditingOrder(null)}>Guardar</button>
                                ) : (
                                    <button className="btn-secondary" onClick={() => setEditingOrder(order.idOrder)}>Editar</button>
                                )}
                                <button className="btn-danger" onClick={() => handleDeleteOrder(order.idOrder)}>Eliminar</button>
                                <button className="btn-primary" onClick={() => handleShowItems(order.idOrder)}>Ver Artículos</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
